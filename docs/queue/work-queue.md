...
| 2026-08-19-Q001 | QUEUE-001 audit (12 findings) + QUEUE-009/010 registered; chip fix DEFERRED per one-fix-per-cycle (chip is audit evidence + QUEUE-002's first item, source fix lands with the CHK-140 source commit next cycle) | docs; gates green at `43978d8` (tsc clean, 1,978/1,978 tests, build green), re-verified at `9a749fe` | `9a749fe` | QUEUE-002 (toast module; chip first) |
