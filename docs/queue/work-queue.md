...
| 81 | QUEUE-066 | Soothing recognition: first clean grade only | MINOR | in-progress | CHK-213: Pass 2 complete. Implement one project-scoped, localized, private, non-blocking acknowledgment after a newly observed genuine `ready` result; no counters, streaks, export claims, or other touchpoints. |
