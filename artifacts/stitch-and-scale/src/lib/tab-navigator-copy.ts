...
export const NAVIGATOR_COPY: Record<LanguageCode, TabNavigatorCopy> = {
  ...
  de: {
    allLabs: 'Alle Labore',
    labsTitle: 'Alle 83 Labore',
    labsDescription: 'Jedes Werkzeug für dieses Muster, gruppiert — damit nichts unsichtbar bleibt.',
    allLabsAriaLabel: 'Gruppierte Liste aller 83 Arbeitsbereichs-Labore öffnen',
  ...
  fr: {
    ...
    labsTitle: 'Les 83 labos',
    labsDescription: 'Tous les outils de ce patron, regroupés pour ne rien laisser hors écran.',
    allLabsAriaLabel: 'Ouvrir la liste groupée des 83 labos de l’espace de travail',
  ...
  pt: {
    ...
    allLabsAriaLabel: 'Abrir a lista agrupada dos 83 laboratórios do espaço de trabalho',
