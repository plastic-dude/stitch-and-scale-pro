...
export interface WorkspaceCopy {
  ...
  readinessIssueDescription: string;
  readinessIssueSeverity: string;
  readinessIssueAffectedSizes: string;
  readinessIssueSourceRun: string;
  readinessIssuePlaceholderDesc: string;
  readinessIssuePlaceholderReproduction: string;
  readinessIssuePlaceholderEvidence: string;
  readinessIssuePlaceholderResolution: string;
  readinessIssuePlaceholderSourceRun: string;
  readinessIssueOptional: string;
  readinessDialogDescription: (stage: string) => string;
  readinessDispositionAccepted: string;
  readinessDispositionRejected: string;
  readinessDispositionDeferred: string;
  readinessStatusOpen: string;
  readinessStatusFixed: string;
  readinessStatusVerified: string;
  readinessPublicationReady: string;
  close: string;
...
export const COPY: Record<LanguageCode, WorkspaceCopy> = {
  en: {
    ...
    readinessIssueDescription: 'Description',
    readinessIssueSeverity: 'Severity',
    readinessIssueAffectedSizes: 'Affected Sizes',
    readinessIssueSourceRun: 'Source QA Run ID',
    readinessIssuePlaceholderDesc: 'e.g. Grading error in XL sleeve cap',
    readinessIssuePlaceholderEvidence: 'Paste relevant stitch counts or measurements...',
    readinessIssuePlaceholderReproduction: 'Steps to reproduce...',
    readinessIssuePlaceholderResolution: 'How was this fixed?',
    readinessIssuePlaceholderSourceRun: 'e.g. RUN-2026-08-22-001',
    readinessIssueOptional: 'optional',
    readinessDialogDescription: (stage: string) => `Report a finding or blocker for the ${stage} stage.`,
    readinessDispositionAccepted: 'Accepted',
    readinessDispositionRejected: 'Rejected',
    readinessDispositionDeferred: 'Deferred',
    readinessStatusOpen: 'Open',
    readinessStatusFixed: 'Fixed',
    readinessStatusVerified: 'Verified',
    readinessPublicationReady: 'PUBLICATION READY',
    close: 'Close',
  ...
  de: {
    ...
    readinessIssueSeverityNitpick: 'Kleinigkeiten',
    readinessIssueSeverityMinor: 'Geringfügig',
    readinessIssueSeverityMajor: 'Wichtig',
    ...
    readinessIssueDescription: 'Beschreibung',
    readinessIssueSeverity: 'Schweregrad',
    readinessIssueAffectedSizes: 'Betroffene Größen',
    readinessIssueSourceRun: 'Quell-QA-Lauf-ID',
    readinessIssuePlaceholderDesc: 'z.B. Gradierungsfehler in XL Ärmelkappe',
    readinessIssuePlaceholderEvidence: 'Relevante Maschenzahlen oder Maße einfügen...',
    readinessIssuePlaceholderReproduction: 'Schritte zur Reproduktion...',
    readinessIssuePlaceholderResolution: 'Wie wurde das behoben?',
    readinessIssueOptional: 'optional',
    readinessIssuePlaceholderSourceRun: 'z.B. RUN-2026-08-22-001',
    readinessDialogDescription: (stage: string) => `Melde einen Befund oder einen Blocker für die Phase ${stage}.`,
    readinessDispositionAccepted: 'Akzeptiert',
    readinessDispositionRejected: 'Abgelehnt',
    readinessDispositionDeferred: 'Aufgeschoben',
    readinessStatusOpen: 'Offen',
    readinessStatusFixed: 'Behoben',
    readinessStatusVerified: 'Verifiziert',
    readinessPublicationReady: 'BEREIT ZUR VERÖFFENTLICHUNG',
    close: 'Schließen',
  ...
  fr: {
    ...
    readinessIssueDescription: 'Description du problème',
    readinessIssueSeverity: 'Sévérité',
    readinessIssueAffectedSizes: 'Tailles concernées',
    readinessIssueSourceRun: 'ID du cycle QA source',
    readinessIssuePlaceholderDesc: 'ex: Erreur de gradation dans la tête de manche XL',
    readinessIssuePlaceholderEvidence: 'Coller les nombres de mailles ou mesures pertinents...',
    readinessIssuePlaceholderReproduction: 'Étapes pour reproduire...',
    readinessIssuePlaceholderResolution: 'Comment cela a-t-il été résolu ?',
    readinessIssuePlaceholderSourceRun: 'ex: RUN-2026-08-22-001',
    readinessIssueOptional: 'optionnel',
    readinessDialogDescription: (stage: string) => `Signaler une constatation ou un bloqueur pour l'étape ${stage}.`,
    readinessDispositionAccepted: 'Accepté',
    readinessDispositionRejected: 'Rejeté',
    readinessDispositionDeferred: 'Reporté',
    readinessStatusOpen: 'Ouvert',
    readinessStatusFixed: 'Corrigé',
    readinessStatusVerified: 'Vérifié',
    readinessPublicationReady: 'PRÊT POUR LA PUBLICATION',
    close: 'Fermer',
  ...
  es: {
    ...
    readinessIssueDescription: 'Descripción',
    readinessIssueSeverity: 'Gravedad',
    readinessIssueAffectedSizes: 'Tallas afectadas',
    readinessIssueSourceRun: 'ID de ciclo de QA de origen',
    readinessIssuePlaceholderDesc: 'ej. Error de graduación en la copa de la manga XL',
    readinessIssuePlaceholderEvidence: 'Pegue los recuentos de puntos o medidas relevantes...',
    readinessIssuePlaceholderReproduction: 'Pasos para reproducir...',
    readinessIssuePlaceholderResolution: '¿Cómo se solucionó?',
    readinessIssuePlaceholderSourceRun: 'ej. RUN-2026-08-22-001',
    readinessIssueOptional: 'opcional',
    readinessDialogDescription: (stage: string) => `Informar un hallazgo o bloqueador para la etapa ${stage}.`,
    readinessDispositionAccepted: 'Aceptado',
    readinessDispositionRejected: 'Rechazado',
    readinessDispositionDeferred: 'Aplazado',
    readinessStatusOpen: 'Abierto',
    readinessStatusFixed: 'Corregido',
    readinessStatusVerified: 'Verificado',
    readinessPublicationReady: 'LISTO PARA PUBLICAR',
    close: 'Cerrar',
  ...
  pt: {
    ...
    readinessIssueDescription: 'Descrição',
    readinessIssueSeverity: 'Gravidade',
    readinessIssueAffectedSizes: 'Tamanhos afetados',
    readinessIssueSourceRun: 'ID do ciclo de QA de origem',
    readinessIssuePlaceholderDesc: 'ex: Erro de graduação na cabeça da manga XL',
    readinessIssuePlaceholderEvidence: 'Cole as contagens de pontos ou medidas relevantes...',
    readinessIssuePlaceholderReproduction: 'Passos para reproduzir...',
    readinessIssuePlaceholderResolution: 'Como isso foi resolvido?',
    readinessIssuePlaceholderSourceRun: 'ex: RUN-2026-08-22-001',
    readinessIssueOptional: 'opcional',
    readinessDialogDescription: (stage: string) => `Relatar uma descoberta ou bloqueador para a etapa ${stage}.`,
    readinessDispositionAccepted: 'Aceito',
    readinessDispositionRejected: 'Rejeitado',
    readinessDispositionDeferred: 'Adiado',
    readinessStatusOpen: 'Aberto',
    readinessStatusFixed: 'Corrigido',
    readinessStatusVerified: 'Verificado',
    readinessPublicationReady: 'PRONTO PARA PUBLICAÇÃO',
    close: 'Fechar',
