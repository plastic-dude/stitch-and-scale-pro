...
import { TAB_COUNT } from './tab-registry';
...
const COPY: Record<LanguageCode, WorkspaceCopy> = {
  en: {
    ...
    allLabs: 'All labs',
    labsTitle: `The ${TAB_COUNT} labs`,
    labsDescription: 'All tools in this pattern, grouped so nothing falls off-screen.',
    allLabsAriaLabel: `Open grouped list of the ${TAB_COUNT} work labs`,
  ...
  de: {
    ...
    allLabs: 'Alle Labs',
    labsTitle: `Die ${TAB_COUNT} Labs`,
    labsDescription: 'Alle Werkzeuge in diesem Muster, gruppiert, damit nichts vom Bildschirm rutscht.',
    allLabsAriaLabel: `Gruppierte Liste der ${TAB_COUNT} Arbeits-Labs öffnen`,
  ...
  fr: {
    ...
    labsTitle: `Les ${TAB_COUNT} labs`,
    labsDescription: 'Tous les outils de ce patron, groupés pour que rien ne sorte de l\'écran.',
    allLabsAriaLabel: `Ouvrir la liste groupée des ${TAB_COUNT} labos de travail`,
  ...
  es: {
    ...
    labsTitle: `Los ${TAB_COUNT} labs`,
    labsDescription: 'Todas las herramientas de este patrón, agrupadas para que nada quede fuera de pantalla.',
    allLabsAriaLabel: `Abrir la lista agrupada de los ${TAB_COUNT} laboratorios del espacio de trabajo`,
  ...
  pt: {
    ...
    labsTitle: `Os ${TAB_COUNT} labs`,
    labsDescription: 'Todas as ferramentas deste padrão, agrupadas para que nada fique fora do ecrã.',
    allLabsAriaLabel: `Abrir a lista agrupada dos ${TAB_COUNT} laboratórios do trabalho`,
